...
public class Pruebas2 {
    public static void main(String[] args) throws JAXBException {
        ...
        List<Producto>listaProductos = new ArrayList<>(){{
                add(new Pizza(1,"Pizza Atun",15.0,SIZE.GRANDE));
                add(new Pizza(1,"Pizza Kebab",15.0,SIZE.GRANDE));
                add(new Pasta(1,"Motzarela",15.0));
                add(new Bebida(1,"Coca cola",15.0,SIZE.GRANDE));
                add(new Pizza(1,"Pizza Atun",15.0,SIZE.GRANDE));
        }};
