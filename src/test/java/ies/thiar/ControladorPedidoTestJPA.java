...
public class ControladorPedidoTestJPA {
    ...
    public void registrarPedido() throws SQLException {
        Cliente cliente = new Cliente("12345678O", "Rodolfo Tebas", "calle dos santos averia", "122312321",
    ...
    // Todos los test de obtenerPedidosByIdClient, obtenerPedidosByState,
    ...
    public void testAgregarLineaPedido() throws SQLException {
        ...
        Pedido pedidoPersistido = controladorPedido.findPedidoById(1);
        assertEquals(2, pedidoPersistido.getLineaPedido().size());
    }

    @Test
    public void testfinalizarPedido() throws SQLException, IllegalAccessException {
        ...
        controladorPedido.insertPedido(pedido);
        controladorPedido.finalizarPedido(pedido,new PagarEfectivo());
        assertEquals(EstadoPedido.FINALIZADO, pedido.getEstado());
    }

    @Test
    public void testCancelarPedido() throws SQLException, IllegalAccessException {
        Cliente cliente = new Cliente("12345678O", "Rodolfo Tebas", "calle dos santos averia", "122312321","email@gmail.com", "1234");
        Pedido pedido = new Pedido(cliente);
        ...
        controladorPedido.insertPedido(pedido);
        controladorPedido.cancelarPedido(pedido);
    }
    ...
    public void testentregarPedido() throws SQLException {
        ...
        controladorPedido.insertPedido(pedido);
        controladorPedido.entregarPedido(pedido);
    }

    @Test
    public void testAnyadirCarrito() throws SQLException, IllegalAccessException {
        Cliente cliente = new Cliente("12345678O", "Rodolfo Tebas", "calle dos santos averia", "122312321","email@gmail.com", "1234");
        Pedido pedido = new Pedido(cliente);
        ...
        controladorPedido.anyadirCarrito(pedido, pizzaPrueba, 5);
    }
}